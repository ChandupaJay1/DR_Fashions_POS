 ...
 * @author MG_Pathum
 */
public class UpdateBuyersDFrame extends javax.swing.JDialog {

    private RegistrationBuyerPanel parentPanel;
    private String originalName; // To identify the record to update

    public UpdateBuyersDFrame(java.awt.Frame parent, boolean modal, RegistrationBuyerPanel panel,
            String name, String email, String mobileNo, String lanNo, String coordinator,
            String address, String companyName, String brandName, String items,
            String brNo, String brName, String paymentMethod, String duePayment) {
        super(parent, modal);
        ...
        jTextField7.setText(lanNo);
        jTextField6.setText(coordinator);
        jTextField5.setText(address);
        jTextField4.setText(companyName);
        jTextField8.setText(brandName);
        jTextField12.setText(items);
        jTextField10.setText(brNo);
        jTextField11.setText(brName);
        jTextField9.setText(paymentMethod);
        jTextField13.setText(duePayment);

        // Add action listeners
        jButton1.addActionListener(evt -> updateBuyer());
        jButton2.addActionListener(evt -> dispose());
    }

    // Overloaded constructor for backward compatibility
    public UpdateBuyersDFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void updateBuyer() {
        ...
        String items = jTextField12.getText().trim();
        ...
        // Database update
        String query = "UPDATE registration_buyers SET "
                + "name=?, email=?, mobile_no=?, lan_no=?, coodinator=?, address=?, "
                + "company_name=?, barnd_name=?, items=?, br_no=?, br_name=?, "
        ...
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement ps = conn.prepareStatement(query)) {
            ...
            ps.setString(10, brNo);
            ps.setString(11, brName);
            ps.setString(12, paymentMethod);
            ps.setString(13, duePayment.isEmpty() ? "0.00" : duePayment);
            ps.setString(14, originalName); // WHERE condition
            ...
            if (result > 0) {
                ...
                JOptionPane.showMessageDialog(this,
                        "⚠️ No buyer found with the name: " + originalName,
                        "Update Failed",
                        JOptionPane.WARNING_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateBuyersDFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateBuyersDFrame dialog = new UpdateBuyersDFrame(new javax.swing.JFrame(), true);
